...
```bash
# 克隆倉庫
git clone https://github.com/freedomw1987/dev_agent.git

# 複製命令文件到 commands 目錄
cp dev_agent/commands/app-development.md \
...
```bash
ln -s $(pwd)/dev_agent/commands/app-development.md \
      /Users/davidchu/www/dev_env/claude/commands/app-development.md
```
...
- [references/spec-kit-workflow.md](./references/spec-kit-workflow.md) - SDD 工作流
- [references/claude-capabilities.md](./references/claude-capabilities.md) - Claude Code 能力
- [references/project-structure.md](./references/project-structure.md) - 專案結構
